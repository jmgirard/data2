...
- **Table Header:** Contains the title and subtitle
- **Stub Head and Stub:** Row labels and row groupings
- **Column Labels:** Variable names and column spanners
- **Table Body:** The actual data cells
