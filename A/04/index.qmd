...
a) Click the button below to download the "cereal.csv" file and save it to your class Project folder.
    - [Download Cereal Data](../../data/cereal.csv){.btn .btn-primary download="cereal.csv"}

b) Use \{tidyverse\} to import this file into R as a tibble named `cereal`, using an argument to make the missing values (coded as `"missing"`) into `NA`s. Then print it.

c) Use an R command to calculate how many variables and observations are in this tibble.
...
cereal <- read_csv("cereal.csv", na = "missing")
cereal
```
...
<div style="display: flex; justify-content: space-between; margin-top: 3rem;">
  <a href="../../index.html" class="btn btn-outline-primary" role="button">&laquo;&nbsp;&nbsp;Week 03</a>
