...
# Download the CSV file to your project folder
library(tidyverse)
dat <- read_csv("penguindata.csv")
dat
```
...
pdata <- read_csv("../../data/penguindata.csv")
print(pdata)
```
...
write_csv(msleep, file = "mammal_sleep_data.csv")
```
