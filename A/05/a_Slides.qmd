...
# Panels are built here and printed one per cell below, so Quarto's layout-ncol=4
# places all eight items -- four charts, four paintings -- on a single grid with
# equal widths and aligned columns. Every cell is 1.2:1, matching the artworks.
library(nycflights13)
blank <- theme_void() + theme(legend.position = "none",
                              plot.margin = margin(1, 1, 1, 1))

# -- scatter: fuel economy against engine size -------------------------------
...
# -- donut: how the same cars divide into classes ---------------------------
dn <- count(mpg, class) |>
...
# -- choropleth: murder arrests per 100,000, by state -----------------------
...
# -- network: 2013 flights out of the three NYC airports --------------------
